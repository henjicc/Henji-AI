...
| 文档可见性 | 公开，无需登录 |
| 价格可见性 | 公开，无需登录 |
| 项目对照 | [catalog/apimart/nano-banana-2-lite.model.ts](../../../src/catalog/apimart/nano-banana-2-lite.model.ts)，`canonicalModelId: 'nano-banana-2-lite'`，与 [Nano Banana 2](../Nano-Banana-2/Nano-Banana-2_APIMart.md) 是**两个独立的产品模型**，不是同一模型下的渠道/分辨率选项 |
