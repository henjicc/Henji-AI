...
> **Nano Banana 2 Lite 已拆分为独立文档**：[Nano-Banana-2-Lite_KIE.md](../Nano-Banana-2-Lite/Nano-Banana-2-Lite_KIE.md)。它在代码里对应独立的 `canonicalModelId: nano-banana-2-lite`（[catalog/kie/nano-banana-2-lite.model.ts](../../../src/catalog/kie/nano-banana-2-lite.model.ts)），是独立产品模型——本文件只覆盖主模型 `nano-banana-2`。
