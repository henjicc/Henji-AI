...
async function verify() {
  ...
  fs.writeFileSync(path.join(consumerRoot, 'runtime-probe.mjs'), [
    ...
    "console.log(JSON.stringify({ package: '@henjicc/ai-sdk', nodeRuntime: true, asr: 5, realtime: 4, translation: 3, falImageUtilities: utilityIds.length, falMultiAngleTools: multiAngleIds.length, groq: 1, externalLlm: 1, discovery: ids.length }))",
  ].join('\n'))
