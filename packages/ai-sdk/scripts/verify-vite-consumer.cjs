...
async function verify() {
  ...
  fs.writeFileSync(path.join(consumerRoot, 'runtime-probe.mjs'), [
    ...
    'if (bailianNonRealtimeAsrPresets.length + volcengineFileAsrPresets.length + siliconFlowAsrPresets.length + groqAsrPresets.length !== 12 || bailianRealtimeAsrPresets.length + volcengineRealtimeAsrPresets.length !== 6 || Object.keys(BAILIAN_QWEN_MT_PRESETS).length !== 3) {',
