...
async function resolveFalSeedreamV4Size(
    ...
    if (resolution.width && resolution.height) {
        return normalizeSeedreamCustomSize(resolution.width, resolution.height, FAL_SEEDREAM_V4_CONSTRAINTS);
    }
    ...
    return calculateSeedreamSizeFromRatio(resolvedRatio, quality, FAL_SEEDREAM_V4_CONSTRAINTS);
}
