/** Grsai Nano Banana Pro 五渠道统一模型（标准 / VT / CL / VIP / 4K VIP）（运行时契约） */
...
// 故 Pro 只暴露这 11 档基础比例，详见 packages/ai-sdk/docs/model-adaptation/Nano-Banana-Pro/Nano-Banana-Pro_Grsai.md。
...
export const grsaiNanoBananaProModel = defineModel({
  ...
  params: [
    {
      id: 'grsaiNanoBananaProChannel', type: 'dropdown', order: 1,
      default: 'standard',
      options: [
        { value: 'standard' },
        { value: 'vt' },
  ...
  request: {
    builder: (params) => {
      ...
      const body: JsonObject = { model: resolved.model, prompt, aspectRatio: ratio, imageSize }
