...
export const kieSeedance20Model = defineModel({
    ...
    params: [
        ...
        {
            id: 'kieSeedance20ReturnLastFrame',
            type: 'switch',
            order: 7,
            default: false
        }
    ...
    request: {
        builder: (params) => {
            ...
            const generateAudio = params.kieSeedance20GenerateAudio !== false
            ...
            const input: JsonObject = {
                ...
                nsfw_checker: true,
                return_last_frame: params.kieSeedance20ReturnLastFrame === true
            };
    ...
    pricing: {
        ...
        description: '480p: $0.095/$0.057 per second (no/with video input); 720p: $0.205/$0.125; 1080p: $0.51/$0.31; 4K: $1.04/$0.64；有视频时按输入与输出总时长计费'
    }
});
