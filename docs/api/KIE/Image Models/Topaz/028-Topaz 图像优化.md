...
paths:
  /api/v1/jobs/createTask:
    post:
      ...
      tags:
        - docs/zh-CN/Market/Image    Models/Topaz
      parameters: []
      requestBody:
        content:
          application/json:
              ...
              properties:
                model:
                  ...
                  description: |-
                    ...
                    - 该端点必须使用 `topaz/image-upscale` 模型
                  examples:
                    - topaz/image-upscale
                callBackUrl:
                  type: string
                ...
                input:
                  ...
                  properties:
                    ...
                    upscale_factor:
                      description: 图像放大倍数（例如 2.0 表示将宽度和高度都放大至原来的 2 倍）
                      type: string
                      enum:
                        - '1'
                        - '2'
          ...
          x-apidog:
            ...
            scopes:
              kn8M4YUlc5i0A0179ezwx:
                BearerAuth: []
      x-apidog-folder: docs/zh-CN/Market/Image    Models/Topaz
      x-apidog-status: released
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-28506646-run
components:
  schemas:
    ApiResponse:
      type: object
