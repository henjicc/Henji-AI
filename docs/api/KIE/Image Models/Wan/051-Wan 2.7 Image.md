...
paths:
  /api/v1/jobs/createTask:
    post:
          ...
          application/json:
            schema:
              ...
              properties:
                model:
                  type: string
                  description: 用于生成任务的模型名称。当前端点固定使用 `wan/2-7-image`。
                  enum:
                    - wan/2-7-image
                ...
                input:
                  ...
                  properties:
                    ...
                    resolution:
                      type: string
                      description: 输出分辨率。当前项目使用 `resolution` 作为包装层字段，对应底层分辨率参数。
                      enum:
                        - 1K
                        - 2K
                      default: 2K
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-32363063-run
components:
  schemas:
    CallbackUrl:
      type: string
