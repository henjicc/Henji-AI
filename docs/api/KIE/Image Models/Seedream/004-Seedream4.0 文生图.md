...
paths:
  /api/v1/jobs/createTask:
    post:
      summary: Seedream4.0 文生图
      deprecated: false
      description: >-
        基于 Seedream4.0 先进 AI 模型的高质量写实风格图像生成
              ...
              properties:
                model:
                  ...
                  description: |-
                    ...
                    - 该端点必须使用 `bytedance/seedream-v4-text-to-image` 模型
                  examples:
                    - bytedance/seedream-v4-text-to-image
                callBackUrl:
                  type: string
                ...
                input:
                  ...
                  properties:
                    prompt:
                      description: 用于生成图像的文本提示词（最大长度：5000 字符）
                      type: string
                      maxLength: 5000
                      examples:
                        - 在黑板上绘制下列二元一次方程组及对应的解题步骤：5x + 2y = 26；2x - y = 5
                    image_size:
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-28506626-run
components:
  schemas:
    ApiResponse:
      type: object
