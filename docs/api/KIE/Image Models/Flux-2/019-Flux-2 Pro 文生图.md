...
paths:
  /api/v1/jobs/createTask:
    post:
      summary: Flux-2 Pro 文生图
      deprecated: false
      description: >-
        基于 Flux-2 先进 AI 模型的高质量写实风格图像生成
              ...
              properties:
                model:
                  ...
                  description: |-
                    ...
                    - 此端点必须使用 `flux-2/pro-text-to-image`
                  examples:
                    - flux-2/pro-text-to-image
                callBackUrl:
                  type: string
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-28506638-run
components:
  schemas:
    ApiResponse:
      type: object
