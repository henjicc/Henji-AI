...
paths:
  /api/v1/jobs/createTask:
    post:
      summary: Flux-2 Pro 图生图
      deprecated: false
      description: >-
        使用 flux-2/pro-image-to-image 进行图像生成
              ...
              properties:
                model:
                  ...
                  description: |-
                    ...
                    - 此端点必须使用 `flux-2/pro-image-to-image`
                  examples:
                    - flux-2/pro-image-to-image
                callBackUrl:
                  type: string
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-28506637-run
components:
  schemas:
    ApiResponse:
      type: object
