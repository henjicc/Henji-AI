...
paths:
  /api/v1/jobs/createTask:
    post:
              ...
              properties:
                model:
                  ...
                  description: |-
                    ...
                    - 该端点必须使用 `ideogram/character-edit` 模型
                  examples:
                    - ideogram/character-edit
                callBackUrl:
                  type: string
                ...
                input:
                  ...
                  properties:
                    ...
                    image_url:
                      description: >-
                        用于生成图像的基础图像 URL。尺寸需与蒙版图像匹配。（为上传后的文件
                    ...
                    mask_url:
                      description: >-
                        用于图像修复的蒙版 URL。尺寸需与基础图像匹配。（为上传后的文件
                        URL，非文件内容；支持的类型：image/jpeg、image/png、image/webp；最大文件大小：10.0MB）
                      type: string
                      examples:
                        - >-
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-28506650-run
components:
  schemas:
    ApiResponse:
      type: object
