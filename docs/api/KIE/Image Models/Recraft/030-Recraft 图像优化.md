...
paths:
  /api/v1/jobs/createTask:
    post:
              ...
              properties:
                model:
                  ...
                  description: |-
                    ...
                    - 该端点必须使用 `recraft/crisp-upscale` 模型
                  examples:
                    - recraft/crisp-upscale
                callBackUrl:
                  type: string
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-28506648-run
components:
  schemas:
    ApiResponse:
      type: object
