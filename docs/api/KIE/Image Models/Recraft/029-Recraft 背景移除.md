...
paths:
  /api/v1/jobs/createTask:
    post:
      summary: Recraft 背景移除
      deprecated: false
      description: >-
        基于 recraft/remove-background 实现图像去背景
      ...
      tags:
        - docs/zh-CN/Market/Image    Models/Recraft
      parameters: []
      requestBody:
        content:
          application/json:
            schema:
              ...
              properties:
                ...
                input:
                  type: object
                  description: 图像去背景任务的输入参数
                  properties:
                    image:
                      description: >-
                        待去除背景的图像。支持格式：PNG、JPG、WEBP。最大 5MB，最大 1600 万像素，最大尺寸
                        4096px，最小尺寸 256px。（为上传后的文件
                        URL，而非文件内容；支持类型：image/jpeg、image/png、image/webp；最大大小：5.0MB）
                      type: string
                      examples:
                        - >-
          ...
          x-apidog:
            ...
            scopes:
              kn8M4YUlc5i0A0179ezwx:
                BearerAuth: []
      x-apidog-folder: docs/zh-CN/Market/Image    Models/Recraft
      x-apidog-status: released
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-28506647-run
components:
  schemas:
    ApiResponse:
      type: object
