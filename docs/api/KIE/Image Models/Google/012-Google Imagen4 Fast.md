...
paths:
  /api/v1/jobs/createTask:
    post:
      ...
      deprecated: false
      description: >-
        基于 Google imagen4-fast 模型实现图像生成
              ...
              properties:
                model:
                  ...
                  description: |-
                    ...
                    - 该端点必须使用 `google/imagen4-fast` 模型
                  examples:
                    - google/imagen4-fast
                callBackUrl:
                  type: string
                ...
                input:
                  ...
                  properties:
                    prompt:
                      ...
                      examples:
                        - >-
                          创作一幅具有电影质感的写实风格中景镜头，呈现 90
                          年代末独立电影的怀旧温情氛围。画面主角是一位染着亮粉色头发（略带褪色痕迹）、满脸雀斑的年轻女孩，她直视镜头，眼神专注，笑容中带着期许又略带一丝忐忑。她身着一件宽松的复古乐队T恤（略有磨损，胸前印有裂纹斑驳的白色文字“KIE
                          AI”），内搭条纹长袖上衣，佩戴简约的银色耳钉。光线为柔和的黄金时刻阳光，透过蒙着薄尘的窗户洒入，形成镜头光晕，照亮空气中漂浮的尘埃。背景是一间模糊的凌乱卧室，墙上贴满海报，挂着串灯，采用浅景深效果呈现。画面带有自然的胶片颗粒感，色调温暖柔和且略微低饱和，女孩富有情绪的双眼清晰对焦，营造出亲密而真实的质感。
                    negative_prompt:
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-28506631-run
components:
  schemas:
    ApiResponse:
      type: object
