...
paths:
  /api/v1/jobs/createTask:
    post:
      summary: ElevenLabs Turbo 2.5文生语音
      deprecated: false
      description: >
        ## 查询任务状态
              ...
              properties:
                model:
                  ...
                  description: |-
                    ...
                    - 此端点必须使用 `elevenlabs/text-to-speech-turbo-2-5`
                  examples:
                    - elevenlabs/text-to-speech-turbo-2-5
                callBackUrl:
                  type: string
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-28506704-run
components:
  schemas:
    ApiResponse:
      type: object
