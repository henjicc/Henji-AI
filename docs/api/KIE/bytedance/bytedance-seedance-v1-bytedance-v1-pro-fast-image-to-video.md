# V1 Pro Fast Image To Video API Documentation

> Kie.ai pricing captured from the model page.

## Pricing

- **Model Type**: v1-pro-fast-image-to-video
- **Model ID**: `bytedance/v1-pro-fast-image-to-video`
- **Source**: https://kie.ai/model/bytedance/v1-pro-fast-image-to-video.md

720P — 16 credits (US$0.080) for 5s / 36 credits (US$0.180) for 10s; 1080P — 36 credits (US$0.180) for 5s / 72 credits (US$0.360) for 10s. Around 30% cheaper than the official rates.
High-tier top-ups (+10% bonus) bring effective pricing down to ~$0.072 for 5s in 720P, ~$0.162 for 10s in 720P, ~$0.162 for 5s in 1080P, and ~$0.324 for 10s in 1080P.

---

> Generate content using the V1 Pro Fast Image To Video model

## Overview

This document describes how to use the V1 Pro Fast Image To Video model for content generation. The process consists of two steps:
...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `bytedance/v1-pro-fast-image-to-video` |
...
|----------|-------|-------------|
| **Format** | `bytedance/v1-pro-fast-image-to-video` | The exact model identifier for this API |
...
- **Default Value**: `"https://file.aiquickdraw.com/custom-page/akr/section-images/1762340693669m6sey187.webp"`
...
```json
{
  ...
  "data": {
    ...
    "resultJson": "{\"resultUrls\":[\"https://static.aiquickdraw.com/tools/example/1762347443777_Ex1oGeMs.mp4\"]}",
    "failCode": null,
    "failMsg": null,
    "costTime": null,
    "completeTime": null,
