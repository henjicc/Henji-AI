...
- **Model Type**: v1-pro-text-to-video
- **Model ID**: `bytedance/v1-pro-text-to-video`
- **Source**: https://kie.ai/model/bytedance/v1-pro-text-to-video.md
...
```json
{
  ...
  "data": {
    ...
    "model": "bytedance/v1-pro-text-to-video",
    "state": "waiting",
    "param": "{\"model\":\"bytedance/v1-pro-text-to-video\",\"input\":{\"prompt\":\"A boy with curly hair and a backpack rides a bike down a golden-lit rural road at sunset.\n[Cut to] He slows down and looks toward a field of tall grass.\n[Wide shot] His silhouette halts in the orange haze.\",\"aspect_ratio\":\"16:9\",\"resolution\":\"720p\",\"duration\":\"5\",\"camera_fixed\":false,\"seed\":-1,\"enable_safety_checker\":true,\"nsfw_checker\":true}}",
