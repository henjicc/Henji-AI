...
paths:
  /api/v1/jobs/createTask:
    post:
      ...
      tags:
        - docs/zh-CN/Market/Video Models/Infinitalk
      parameters: []
      requestBody:
        content:
          application/json:
              ...
              properties:
                model:
                  ...
                  description: |-
                    ...
                    - 该接口必须使用 `infinitalk/from-audio` 模型
                  examples:
                    - infinitalk/from-audio
                callBackUrl:
                  type: string
                  ...
                  properties:
                    ...
                    prompt:
                      ...
                      examples:
                        - 一位留着深色长发的年轻女性正在录制播客。
                    resolution:
                      description: 待生成视频的分辨率。仅支持 480p 或 720p。
                      type: string
                      enum:
                        - 480p
                        - 720p
                      ...
                      examples:
                        - 480p
                    seed:
                      description: 用于结果可复现的随机种子值。有效范围为 10000 至 1000000。
                      type: number
                  required:
                    - image_url
                    - audio_url
          ...
          x-apidog:
            ...
            scopes:
              kn8M4YUlc5i0A0179ezwx:
                BearerAuth: []
      x-apidog-folder: docs/zh-CN/Market/Video Models/Infinitalk
      x-apidog-status: released
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-28506698-run
components:
  schemas:
    ApiResponse:
      type: object
