...
paths:
  /api/v1/jobs/createTask:
    post:
              ...
              properties:
                model:
                  ...
                  description: |-
                    ...
                    - 该接口必须使用 `kling/ai-avatar-standard` 模型
                  examples:
                    - kling/ai-avatar-standard
                callBackUrl:
                  type: string
                ...
                input:
                  ...
                  properties:
                    ...
                    audio_url:
                      description: >-
                        音频文件的 URL（需为上传后的文件
                        URL，而非文件内容；支持的格式：audio/mpeg、audio/wav、audio/x-wav、audio/aac、audio/mp4、audio/ogg；音频大小限制为100M,并且时长不超过5分钟）
                      type: string
                      examples:
                        - >-
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-28506662-run
components:
  schemas:
    ApiResponse:
      type: object
