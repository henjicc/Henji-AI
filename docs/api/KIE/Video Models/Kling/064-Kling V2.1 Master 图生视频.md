...
paths:
  /api/v1/jobs/createTask:
    post:
      summary: Kling V2.1 Master 图生视频
      deprecated: false
      description: >-
        ## 查询任务状态
        ...
        content:
          application/json:
              ...
              properties:
                model:
                  ...
                  description: |-
                    ...
                    - 该接口必须使用 `kling/v2-1-master-image-to-video` 模型
                  examples:
                    - kling/v2-1-master-image-to-video
                callBackUrl:
                  type: string
                ...
                input:
                  ...
                  properties:
                    prompt:
                      ...
                      maxLength: 5000
                      examples:
                        - 一队伞兵降落到敌方区域，穿越云层时，镜头切换为战场上空的缓慢平移视角，战场被火光点亮
                    image_url:
                      description: >-
                    ...
                    duration:
                      ...
                      examples:
                        - '5'
                    negative_prompt:
                      description: 用于排除视频中特定元素的反向提示词（最大长度：500 字符）
                      type: string
                      maxLength: 500
                      examples:
                        - 模糊、畸变、低画质
            ...
            example:
              ...
              input:
                prompt: 一队伞兵降落到敌方区域，穿越云层时，镜头切换为战场上空的缓慢平移视角，战场被火光点亮
                image_url: >-
                  https://file.aiquickdraw.com/custom-page/akr/section-images/1755256297923kmjpynul.png
                duration: '5'
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-28506664-run
components:
  schemas:
    ApiResponse:
      type: object
