...
paths:
  /api/v1/jobs/createTask:
    post:
              ...
              properties:
                model:
                  ...
                  description: |-
                    ...
                    - 该端点必须使用 `wan/2-2-animate-move` 模型
                  examples:
                    - wan/2-2-animate-move
                callBackUrl:
                  type: string
                ...
                input:
                  ...
                  properties:
                    video_url:
                      description: >-
                        输入视频的 URL。（为上传后的文件
                        URL，非文件内容；支持的类型：video/mp4、video/quicktime、video/x-matroska；最大文件大小：10.0MB）
                      type: string
                      examples:
                        - >-
                    ...
                    resolution:
                      description: 生成视频的分辨率（480p、580p 或 720p）。
                      type: string
                      enum:
                        - 480p
                        - 580p
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-28506695-run
components:
  schemas:
    ApiResponse:
      type: object
