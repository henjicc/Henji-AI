...
paths:
  /api/v1/jobs/createTask:
    post:
      summary: Wan - Flash 视频转视频
      deprecated: false
      description: |-
        > 使用 wan/2-6-flash-video-to-video 进行内容生成
              ...
              properties:
                model:
                  ...
                  description: |-
                    ...
                    - 此端点必须为 `wan/2-6-flash-video-to-video`
                  examples:
                    - wan/2-6-flash-video-to-video
                callBackUrl:
                  type: string
                ...
                input:
                  ...
                  properties:
                    ...
                    video_urls:
                      description: >-
                        用于生成视频的视频 URL（上传后的文件 URL，非文件内容；接受类型：video/mp4,
                        video/quicktime, video/x-matroska；最大大小：10.0MB）
                      type: array
                      items:
                        type: string
                        format: uri
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-28642145-run
components:
  schemas:
    ApiResponse:
      type: object
