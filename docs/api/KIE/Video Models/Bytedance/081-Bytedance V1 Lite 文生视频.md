...
paths:
  /api/v1/jobs/createTask:
    post:
      summary: Bytedance V1 Lite 文生视频
      deprecated: false
      description: >-
        ## 查询任务状态
                  ...
                  properties:
                    ...
                    aspect_ratio:
                      ...
                      examples:
                        - '16:9'
                    resolution:
                      description: 视频分辨率 - 480p 生成速度更快，720p 画质更高
                      type: string
                      enum:
                        - 480p
                        - 720p
                    ...
                    camera_fixed:
                      ...
                      examples:
                        - false
                    seed:
                      description: 用于控制视频生成的随机种子值。设为 -1 时随机生成。
                      type: integer
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-28506675-run
components:
  schemas:
    ApiResponse:
      type: object
