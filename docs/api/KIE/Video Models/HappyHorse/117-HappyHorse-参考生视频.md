...
paths:
  /api/v1/jobs/createTask:
    post:
              ...
              properties:
                model:
                  ...
                  description: |-
                    ...
                    - 该接口必须使用 `happyhorse/reference-to-video` 模型
                  enum:
                ...
                input:
                  ...
                  properties:
                    prompt:
                      type: string
                      description: 用于描述视频内容，并用 character1/character2/... 指代参考图中的角色/主体。
                      maxLength: 5000
                      examples:
                        - >-
                    ...
                    image_urls:
                      ...
                      items:
                        type: string
                      description: >-
                        参考图片 URL 列表（顺序很重要，对应
                        character1、character2...）。图像限制：格式：JPEG、JPG、PNG、WEBP。分辨率：短边不低于400像素，推荐720P以上清晰图。避免传入过小、模糊或压缩过度的图像，影响效果。文件大小：不超过10MB。
                      minItems: 1
                      maxItems: 9
                    resolution:
                      type: string
            ...
            example:
              ...
              input:
                prompt: >-
                  身着红色旗袍的女性character1，镜头先以侧面中景勾勒旗袍修身剪裁与S型曲线，随即切换至低角度仰拍，捕捉她轻抬玉手展开折扇character2时流苏耳坠character3随头部转动轻盈摆动的细节，最后推近至面部特写，定格在她指尖轻点扇骨、眼波流转间的含蓄风情，多视角全方位展现东方韵味。
                image_urls:
                  - https://loremflickr.com/400/400?lock=7736377935219762
                  - https://loremflickr.com/400/400?lock=2805046659249701
                resolution: 1080p
                aspect_ratio: '16:9'
                duration: 5
                seed: 1851569351
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-34251528-run
components:
  schemas:
    ApiResponse:
      type: object
