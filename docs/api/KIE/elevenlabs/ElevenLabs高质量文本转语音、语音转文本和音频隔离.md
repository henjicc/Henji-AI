# ElevenLabs Turbo 2.5 文本转语音

使用 `elevenlabs/text-to-speech-turbo-2-5` 模型进行内容生成。

## 接口调用

**请求方法:** POST
**接口地址:** `/api/v1/jobs/createTask`
...
*   **类型:** enum<string>
*   **必需:** 是
*   **默认值:** `elevenlabs/text-to-speech-turbo-2-5`
*   **描述:** 用于生成的模型名称。必填字段。此端点必须使用 `elevenlabs/text-to-speech-turbo-2-5`。
*   **可用选项:** `elevenlabs/text-to-speech-turbo-2-5`
*   **示例:** `"elevenlabs/text-to-speech-turbo-2-5"`
