---
title: "VIDU Q2 Pro 图生视频 - PPIO 派欧云文档中心"
url: "https://ppio.com/docs/models/reference-vidu-q2-pro-img2video"
captured_at: "2026-03-19T05:08:20.181Z"
---
# VIDU Q2 Pro 图生视频

## 接口信息
- **方法**: POST
- **路径**: `/v3/async/vidu-q2-pro-img2video`
- **类型**: 异步 API

## 描述
VIDU Q2 Pro 图像转视频 API，支持多种分辨率选项。根据参考图像生成新的视频内容。
...
```bash
curl --request POST \
 --url https://api.ppio.com/v3/async/vidu-q2-pro-img2video \
