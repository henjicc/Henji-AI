---
title: "VIDU Q2 Pro 智能多帧 - PPIO 派欧云文档中心"
url: "https://ppio.com/docs/models/reference-vidu-q2-pro-multiframe"
captured_at: "2026-03-19T05:08:15.722Z"
---
# VIDU Q2 Pro 智能多帧

## 接口信息
- **路径**: `POST /v3/async/vidu-q2-pro-multiframe`
- **描述**: VIDU Q2 Pro 多帧图像转视频 API，通过多张关键帧图像生成高质量连贯视频内容。
- **类型**: 异步 API，仅返回异步任务的 `task_id`，需使用该 ID 调用查询任务结果 API 获取视频生成结果。
...
| `watermark` | boolean | 否 | `false` | 是否添加水印。`true`：添加水印；`false`：不添加水印。 |
...
```bash
curl --request POST \
 --url https://api.ppio.com/v3/async/vidu-q2-pro-multiframe \
