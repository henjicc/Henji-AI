...
captured_at: "2026-03-18T04:14:46.899Z"
---
...
| `prompt` | string | - | **必填**。用于生成图像的提示词，支持中英文。建议不超过300个汉字或600个英文单词。 |
