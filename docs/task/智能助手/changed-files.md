...
- `00-任务总览.md`、`progress.md`、`handoff.md`：明确 1～7 阶段代码实现已完成；4～7 阶段只剩真实手动验收，8.1/8.2 依赖本轮验收后启动。
- 6.1/6.2/6.4/6.5、7.1～7.4 任务文件：补齐实现记录、代码验收勾选和真实手动验收边界，避免把“待手动验证”误读为“缺少代码”。
- `test-report.md`：记录最终自动复验与任务审计结论。
