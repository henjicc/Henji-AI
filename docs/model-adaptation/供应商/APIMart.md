...
| 项目 | 位置 |
|---|---|
| 请求执行 | [electron/main/services/ai-runtime/providers/apimart.ts](../../../electron/main/services/ai-runtime/providers/apimart.ts) |
| 连接检测 / 余额 | [provider-connection.ts](../../../electron/main/services/ai-runtime/provider-connection.ts) → `GET /v1/balance` |
| 上传改写 | [upload.ts](../../../electron/main/services/ai-runtime/upload.ts) → APIMart 图片走 `uploadToApiMart` |
| 上传实现 | [upload-providers.ts](../../../electron/main/services/ai-runtime/upload-providers.ts) → `POST /v1/uploads/images` |
