...
> APIMart 上 Gemini Omni Flash 是**两个模型、两份文档**，能力集合与限制差异很大，适配时不要合并。
...
- **两条渠道差异极大**：官方渠道只有 720p、时长 3–10 秒、参考图最多 16 张、支持 `extend_from_task_id` 多轮编辑；Ext 渠道有 1080p/4k、时长只能 4/6/8/10、参考图只能 0/1/3 张、没有多轮编辑。**必须拆成两个模型。**
