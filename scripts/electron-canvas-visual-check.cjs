...
const REGISTERED_NODE_TYPES = [
  'universalUploadNode', 'uploadNode', 'imageNode', 'panoramaGenNode', 'panoramaViewerNode', 'exportImageNode', 'textProcessingNode', 'textAnnotationNode', 'groupNode', 'assetGroupNode',
...
async function applyConfig(page, name) {
  ...
  await page.evaluate(({ styleId, css }) => {
    ...
    style.textContent = `${css}\n*{animation:none!important;transition:none!important;caret-color:transparent!important;}\n.canvas-edge-flow-pulse,.canvas-edge-flow-layer{display:none!important;}`
