...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            image_commands::split_prepare_commands::split_image,
            image_commands::split_prepare_commands::split_image_source,
            image_commands::merge_commands::merge_storyboard_images,
            image_commands::metadata_commands::read_storyboard_image_metadata,
            image_commands::metadata_commands::embed_storyboard_image_metadata,
            image_commands::split_prepare_commands::prepare_node_image_source,
            image_commands::split_prepare_commands::prepare_node_image_binary,
            image_commands::split_prepare_commands::crop_image_source,
            image_commands::io_commands::load_image,
            image_commands::io_commands::persist_image_source,
            image_commands::io_commands::persist_image_binary,
            image_commands::io_commands::save_image_source_to_downloads,
