...
const DIFFUSION_PRESETS: readonly DiffusionPresetDefinition[] = [
  ...
  createPreset({
    ...
    parameters: { strength: 0.34, glowRange: 0.34, highlightResponse: 0.36, softness: 0.2, blackRetention: 1, detailRetention: 1, colorRetention: 0.96 },
  }),
  createPreset({
    ...
    parameters: { strength: 0.58, glowRange: 0.56, highlightResponse: 0.44, softness: 0.48, blackRetention: 1, detailRetention: 1, colorRetention: 0.93 },
  }),
  createPreset({
    id: 'glow-high', mode: 'glow', intensity: 'high',
    name: { zh: '通用辉光 · 强', en: 'General Glow · High' },
    description: { zh: '形成宽而连续的高光光晕，强效果下仍保留原始亮边结构。', en: 'Builds a broad continuous halo while retaining the original highlight structure.' },
    parameters: { strength: 0.82, glowRange: 0.78, highlightResponse: 0.58, softness: 0.72, blackRetention: 1, detailRetention: 1, colorRetention: 0.9 },
  }),
];
