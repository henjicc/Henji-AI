...
export interface EmbeddedAgentMessage { id: string; role: 'user' | 'assistant'; text: string }
...
export interface EmbeddedAgentModel { providerId: string; modelId: string; name: string }
