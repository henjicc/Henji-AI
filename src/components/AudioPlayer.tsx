    ...
    >
      ...
      <div className="mt-3 flex items-center justify-between">
        <div className="relative flex items-center">
          <button className="text-zinc-300 hover:opacity-70" title={t('ui:audioPlayer.volume')}>
        ...
        <div className="flex items-center">
          <button onClick={togglePlay} className="text-zinc-300 hover:opacity-70" title={t('ui:audioPlayer.playPause')}>
            {isPlaying ? (
