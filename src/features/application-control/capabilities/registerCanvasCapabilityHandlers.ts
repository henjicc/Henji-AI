...
import type {
  CanvasNodePlacement,
} from '@/core/application-control/domains/canvas/canvasMutationApplicationCapabilities'
import {
  OPEN_MULTI_LAYER_DOCUMENT_NODE_EDITOR_CAPABILITY_ID,
  RETRY_LAYER_STACK_RESULT_CAPABILITY_ID,
} from '@/core/application-control/domains/canvas/canvasEditorApplicationCapabilities'
