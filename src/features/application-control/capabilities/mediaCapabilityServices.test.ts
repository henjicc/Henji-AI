...
vi.mock('@/features/navigation/application/surfaceCapabilityService', () => ({ openApplicationSurface }))

import { listGenerationHistory } from '@/features/generation/application/generationHistoryCapabilityService'
import { createImageEditPreviewFromRef, openImageEditorWithSource } from '@/features/imageEdit/application/imageSourceCapabilityService'
import { createGenerationReflectionRegistrations, GENERATION_ENTITY_TYPES } from '@/features/generation/application/generationReflection'
