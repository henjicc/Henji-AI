...
import { createEmptyImageEditDocument, createImageEditOperation, IMAGE_EDIT_OPERATION_IDS } from '@/core/imageEdit/index'
...
import { registerImageMarkCapabilityHandlers } from '@/features/imageMark/application/registerImageMarkCapabilityHandlers'
