...
const ShotClipTrack: React.FC<ShotClipTrackProps> = ({
  ...
  return (
    <div className="relative shrink-0" style={{ width: contentWidth, height: SHOT_CLIP_TRACK_HEIGHT }}>
      ...
      {drag.preview && (
        <div
          className="pointer-events-none absolute z-40 -translate-x-1/2 whitespace-nowrap rounded bg-accent px-1.5 py-0.5 font-mono text-[10px] font-medium text-white shadow"
