...
export const nodeTypes: NodeTypes = {
  ...
  uploadNode: withNodePaintFrame(UniversalUploadNode),
  ...
  videoUploadNode: withNodePaintFrame(UniversalUploadNode),
  audioUploadNode: withNodePaintFrame(UniversalUploadNode),
