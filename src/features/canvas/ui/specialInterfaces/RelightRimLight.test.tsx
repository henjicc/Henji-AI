...
describe('轮廓光灯位交互', () => {
  it('拖动只预览，松手提交八方位且不改变主光；取消恢复原灯位', () => {
    ...
    fireEvent.pointerDown(rim, { button: 0, pointerId: 1 })
    fireEvent.pointerMove(rim, { pointerId: 1, clientX: 170, clientY: 170 })
