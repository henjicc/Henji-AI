...
import type { ApplicationExecutionContext } from '@/core/application-control/index'
...
import { getSettingsRegistryRevision } from '@/features/settings/application-control/index'
