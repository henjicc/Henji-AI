...
import { APPLICATION_WINDOW_OBSERVATION_TARGET, prefersNativeMediaObservation, type ApplicationObservationTarget } from '@/core/application-control/applicationSurfaces'
