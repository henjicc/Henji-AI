  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col bg-app">
      ...
      <div ref={scrollRef} className="ui-scrollbar min-h-0 flex-1 space-y-3 overflow-y-auto px-3 py-4">
        ...
        {currentGoal ? (
          <section className="ml-7 rounded-xl border border-border-dark bg-layer p-3">
        ...
        {artifacts.map((artifact) => artifact.type === 'ArtifactOffloaded' ? (
          <section key={artifact.eventId} className="flex items-start gap-2 rounded-xl border border-border-dark bg-surface-dark p-3 text-xs text-text-muted">
        ...
        {streamedText && runState && !terminalStatuses.has(runState.status) ? (
          <section className="mr-7 rounded-xl border border-border-dark bg-panel p-3">
        ...
        {runState?.error ? (
          <section className="rounded-xl border border-danger/30 bg-danger/10 p-3 text-xs text-danger">
