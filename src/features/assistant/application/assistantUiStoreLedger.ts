import type { ApplicationStoreActionLedger } from '@/core/application-control/index'

import type { useAssistantUiStore } from '@/features/assistant/store/assistantUiStore'
