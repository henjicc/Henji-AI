...
export const minimaxSpeech26Model = defineModel({
  ...
  params: [
    // 1. 音频规格
    {
      ...
      type: 'dropdown',
      order: 1,
      name: sharedFieldText('audioSpec'),
      default: 'hd',
      options: [
        { value: 'hd', label: 'HD' },
    ...
    // 7. 采样率
    {
      ...
      type: 'dropdown',
      order: 7,
      name: sharedFieldText('sampleRate'),
      default: 32000,
      options: [
    ...
    // 9. 音频格式
    {
      ...
      type: 'dropdown',
      order: 9,
      name: sharedFieldText('audioFormat'),
      default: 'mp3',
      options: [
        { value: 'mp3', label: 'MP3' },
        { value: 'wav', label: 'WAV' },
