/**
 * ModelScope MajicMix Realistic 模型
 */
...
export const modelscopeMajicMixRealisticModel = defineModel({
  meta: {
    ...
    provider: 'modelscope',
    type: 'image',
    name: { zh: 'majicMIX Realistic', en: 'majicMIX Realistic' },
    description: { zh: '魔搭 majicMIX 写实风格模型', en: 'ModelScope majicMIX realistic model' },
  ...
  request: {
    builder: (params) => buildModelscopeRequest(params, {
      modelId: 'MusePublic/majicMIX_realistic',
      allowGuidance: true,
...
export default modelscopeMajicMixRealisticModel
