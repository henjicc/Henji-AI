/** Fal Qwen Image 3.0 图片生成与编辑模型 */

import { defineModel, sharedFieldText, sharedOptionText } from '@/core'

const QWEN_IMAGE_3_RATIOS = ['1:1', '4:3', '3:4', '16:9', '9:16'] as const
...
export const falQwenImage30Model = defineModel({
  meta: {
    ...
    provider: 'fal', type: 'image', i18nScope: 'models.defs.fal-ai-qwen-image-3.0',
  ...
  params: [
    {
      ...
      options: [{ value: 'smart', label: sharedOptionText('smart') }, ...QWEN_IMAGE_3_RATIOS.map((value) => ({ value, label: value }))]
    },
    {
