...
export const falNanoBanana2Model = defineModel({
  meta: {
    ...
    provider: 'fal', type: 'image', i18nScope: 'models.defs.fal-ai-nano-banana-2',
  ...
  params: [
    {
      ...
      options: [{ value: 'smart', label: sharedOptionText('smart') }, ...NANO_BANANA_2_RATIOS.map((value) => ({ value, label: value }))]
    },
    {
    ...
    },
    {
      ...
      name: { zh: '思考强度', en: 'Thinking' }, default: 'off',
      options: [
