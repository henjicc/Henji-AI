/** Fal Seedream 5.0 Pro 图片生成与编辑模型 */
...
export const falSeedream50ProModel = defineModel({
  meta: {
    ...
    provider: 'fal', type: 'image', i18nScope: 'models.defs.fal-ai-seedream-5.0-pro',
  ...
  params: [
    {
      ...
      options: [{ value: 'smart', label: sharedOptionText('smart') }, ...SEEDREAM_PRO_RATIOS.map((value) => ({ value, label: value }))]
    },
    {
