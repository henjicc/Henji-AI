/** APIMart Seedream 5.0 Lite 图片生成与编辑模型 */
...
export const apimartSeedream50LiteModel = defineModel({
  meta: {
    ...
    provider: 'apimart', type: 'image', i18nScope: 'models.defs.apimart-seedream-5.0-lite',
  ...
  params: [
    ...
    },
    {
      ...
      name: { zh: '生成数量', en: 'Output Count' }, default: 1, min: 1, max: 15, step: 1
    }
  ],
