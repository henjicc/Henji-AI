...
export interface AssetQueryInput { mediaType?: AssetMediaType; libraryId?: string; keyword?: string; page?: number; pageSize?: number; sort?: 'created' | 'recent' }
